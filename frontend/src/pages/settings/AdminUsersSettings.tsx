            ...
            >
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-mist-600">
                  {t(`adminUsers.role${eintrag.role === 'admin' ? 'Admin' : eintrag.role === 'approver' ? 'Approver' : 'User'}`)}
                  {' · '}
                  ...
                  return (
                    <div key={kind} className="flex flex-col gap-1.5">
                      <span className="text-xs font-medium tracking-wide text-mist-600 uppercase">
                        {t(kind === 'movies' ? 'adminUsers.quotaMovies' : 'adminUsers.quotaSeries')}
                      </span>
                      <input
                        type="number"
                        min={0}
                        ...
                        aria-label={t(
                          kind === 'movies' ? 'adminUsers.quotaMovies' : 'adminUsers.quotaSeries',
                        )}
